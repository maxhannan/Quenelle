...
export default function MenusLayout() {
  ...
  return (
    <div className="flex ">
      <div className="relative xl:w-1/3 2xl:w-1/4 border-r bg-zinc-100 dark:border-zinc-800 h-screen   dark:bg-zinc-900 overflow-y-scroll flex-none hidden xl:flex scrollbar-none scrollbar-track-zinc-100 dark:scrollbar-track-zinc-900 scrollbar-thumb-zinc-600 dark:scrollbar-thumb-zinc-500 scrollbar-thumb-rounded-2xl">
        <div className=" container mx-auto max-w-4xl pl-2 pr-3">
          <SlideDownTransition>
      ...
      <div className="w-full xl:h-screen xl:overflow-y-scroll scrollbar-none scrollbar-track-zinc-200 ">
        <Outlet
          context={{
            dishes,
            menus,
