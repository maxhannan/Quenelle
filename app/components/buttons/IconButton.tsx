...
const IconButton: FC<Props> = ({
  ...
  return (
    <button
      ...
      }   h-${size}  w-${size} transition-all duration-200 justify-center   border  dark:border-zinc-700 border-zinc-300   hover:text-white focus:ring-4 focus:outline-none focus:ring-neutral-300 font-medium rounded-full text-sm p-2 text-center inline-flex items-center    dark:focus:ring-neutral-800 `}
    >
